...
codeunit 13648 "OIOUBL-Common Logic"
{
    ...
    procedure InsertPaymentMeansDSM(var InvoiceElement: XmlElement; DueDate: Date; Kortart: Code[2];"Betalings-ID": Code[16];BetalingsType: Text[50];"Fik/Giro-No.":Code[20]);
    var
        PaymentMeansElement: XmlElement;
    begin
        //DSMJMA#3001 ->
        ...
        PaymentMeansElement.Add(XmlElement.Create('PaymentDueDate', DocNameSpaceCBC,
          OIOUBLDocumentEncode.DateToText(DueDate)));
        PaymentMeansElement.Add(XmlElement.Create('InstructionID', DocNameSpaceCBC, "Betalings-ID"));
        PaymentMeansElement.Add(
          XmlElement.Create('PaymentID', DocNameSpaceCBC,
